...
public class Ch3Ex2Activity extends AppCompatActivity {
    ...
    private void resetTargetAnimation() {
        ...
        ObjectAnimator animator2 = ObjectAnimator.ofFloat(target,"scaleX",1f,2f,1f);
        ...
        ObjectAnimator animator3 = ObjectAnimator.ofFloat(target,"scaleY",1f,2f,1f);
        ...
        ObjectAnimator animator4 = ObjectAnimator.ofFloat(target,"alpha",1f,0.5f,1f);
        ...
        animator5.setRepeatMode(ObjectAnimator.RESTART);
